...
"""
get_data:
reads from the audio stream from microphone, for a constant length of time, converts it to data
inputs: stream, PyAudio object
outputs: int16 data array, representing amplitude of audio at each sample point
"""
