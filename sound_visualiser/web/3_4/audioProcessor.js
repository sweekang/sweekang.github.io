...
// --- Start of Pitch Detection Functions ---

// Constants and Parameters for Pitch Detection
const NOTE_NAMES = ["A", "A#", "B", "C", "C#", "D", "D#", "E", "F", "F#", "G", "G#"];
const DELTA1 = 0.015//0.025; // Threshold for peak detection
...
function polyphonicPitchDetectionIterative(audioFrame, fs) {
    ...
    return detectedPitches; // Return the list of detected pitches
}
// --- End of Pitch Detection Functions ---


// --- Start of Onset Detection Module-Level State and Functions ---
...
let hop_size = chunk_size; // Hop size (assuming equal to chunk size)
...
// --- End of Onset Detection Module-Level State and Functions ---
